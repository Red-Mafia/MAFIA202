...
░█▀▄░█▀▀░█░█░▄▄▄░█░█░█▀█░█▀▀░░█░░█▀█
░▀░▀░▀▀▀░▀▀░░░░░░▀░▀░▀░▀░▀░░░▀▀▀░▀░▀                                
     \x1b[1;97m Author   \033[31;1m:  \033[32mR3D-M4FI4
     \x1b[1;97m Type     \033[31;1m:  \033[32mBruteForce
     \x1b[1;97m Version  \033[31;1m:  \033[32m0.1
     \x1b[1;97m Whatsapp  \033[31;1m:  \033[32m03188214452
     \x1b[1;97m
"""
...
def info_tools():
    ...
    print '\n %s[%s>%s] Yt       : Irsriazyt.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Author   : Sayyed RED-MAFIA(RK).'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Github   : https://github.com/Red-Mafia'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Facebook : https://www.facebook.com/Riaz-hacker-100835532473815/'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Fanspage : Riaz hacker'%(N,H,N);time.sleep(0.07)
